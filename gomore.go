...
func TokenTypeToString(i int) string {
    if ( i == T_UNDECIDED) { return "T_UNDECIDED" }
    if ( i == T_INT) { return "T_INT" }
    if ( i == T_FLOAT) { return "T_FLOAT" }
    if ( i == T_HEX) { return "T_HEX" }
    if ( i == T_PERCENT) { return "T_PERCENT" }
    if ( i == T_PIXELS) { return "T_PIXELS" }
    if ( i == T_STRING) { return "T_STRING" }
    if ( i == T_COMMENT) { return "T_COMMENT" }
    if ( i == T_LINECOMMENT) { return "T_LINECOMMENT" }
    if ( i == T_PATH) { return "T_PATH" }
    if ( i == T_LPAREN) { return "T_LPAREN" }
    if ( i == T_RPAREN) { return "T_RPAREN" }
    if ( i == T_LBRACE) { return "T_LBRACE" }
    if ( i == T_RBRACE) { return "T_RBRACE" }
    if ( i == T_LBRACK) { return "T_LBRACK" }
    if ( i == T_RBRACK) { return "T_RBRACK" }
    if ( i == T_SELECTOR) { return "T_SELECTOR" }
    if ( i == T_VARIABLE) { return "T_VARIABLE" }
    if ( i == T_COLON) { return "T_COLON" }
    if ( i == T_SEMICOLON) { return "T_SEMICOLON" }
    if ( i == T_DASH) { return "T_DASH" }
    if ( i == T_MUL) { return "T_MUL" }
    if ( i == T_PLUS) { return "T_PLUS" }
    if ( i == T_MINUS) { return "T_MINUS" }
    if ( i == T_COMMA) { return "T_COMMA" }
    if ( i == T_PERIOD) { return "T_PERIOD" }
    if ( i == T_GT) { return "T_GT" }
    if ( i == T_LT) { return "T_LT" }
    if ( i == T_EQ) { return "T_EQ" }
    if ( i == T_GUARD) { return "T_GUARD" }
    return "UNKNOWN_TYPE"
}
